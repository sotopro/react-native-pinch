...
public class HttpUtil {
    ...
    private HttpsURLConnection prepareRequest(HttpRequest request)
            throws IOException, UnrecoverableKeyException, KeyStoreException, CertificateException, KeyManagementException, NoSuchAlgorithmException, JSONException {
    ...
    public HttpResponse sendHttpRequest(HttpRequest request)
            throws UnknownHostException, IOException, KeyStoreException, CertificateException, KeyManagementException, NoSuchAlgorithmException, JSONException, UnrecoverableKeyException {
